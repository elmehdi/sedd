...
public class SeddApplication {
    ...
    public static void main(String[] args) {
        ...
        Intervention intervention1 = new Intervention(java.sql.Date.valueOf("2021-08-30"), Type.Curatif, "Cruella", java.sql.Time.valueOf("20:59:10"), "01:20:00",
                "This an observation", "workr a", "M22", Panne.Materiel);
        Intervention intervention2 = new Intervention(java.sql.Date.valueOf("2021-02-10"), Type.Curatif, "Cruella", java.sql.Time.valueOf("20:59:10"), "01:20:00",
        ...
        intervenantRepository.save(mehdi);
